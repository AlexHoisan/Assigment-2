...
<div>
  ...
  <app-dashboard @cartChanged="cart = $event" :cart="cart">
  </app-dashboard>
  ...
  <section class="dropdowns">
    <div class="container-fluid">
      <div class="row" style="position: relative">
        ...
        <app-sorting-dropdown :userSorting="sorting"
                              @sortingChanged="sorting = $event">
        </app-sorting-dropdown>
        <app-vegetarian-dropdown :userVegetarian="vegetarian"
                                  @vegetarianChanged="vegetarian = $event">
        </app-vegetarian-dropdown>
        <app-price-bar :priceBar="priceBar"
  ...
  <section class="food">
    <div class="row">
      <app-foods :userCategory="category" @categoryChanged="category = $event"
                  :userSorting="sorting"
                  @sortingChanged="sorting = $event"
      ...
      <app-food-modal @cartChanged="cart = $event" :cart="cart">
      </app-food-modal>
    </div>
  </section>
